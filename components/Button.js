// This Button componenent creates either a boxed button or a text button
// depending on the parameter passed.
// It uses the label and onPress parameters too
//
// How to use <Button>?
// - style: it can either be a 'button' or 'text'. It depends on where you
// button has a background in the back or not
